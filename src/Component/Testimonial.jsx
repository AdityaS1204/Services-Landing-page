...
const Testimonial = () => {
  ...
  return (
    <div className='mt-20 p-8 flex flex-col rounded-2xl border bg-neutral-200/30 shadow-lg h-auto w-11/12 border-slate-300'>
      ...
      <div className="h-auto w-full bg-amber-500 rounded-box space-x-4 p-12 flex mt-12">
        ...
        {testimonials.map((testimonial, index) => (
          <div className="relative carousel-item lg:h-[500px] h-[300px] w-[220px] lg:w-[300px] rounded-4xl flex shrink-0  mr-7 " key={index}>
            ...
            <div className="absolute inset-0 p-6  hover:backdrop-blur-2xl duration-700 rounded-4xl group flex flex-col justify-end">
