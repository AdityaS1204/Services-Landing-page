...
const Companies = () => {
  return (
    <div className="w-10/12 m-24">
      <h2 className="text-5xl font-semibold font-Montserrat text-center m-8 text-slate-900">Our Trusted Brands</h2>
      <Marquee pauseOnHover loop={0} gradient gradientColor="#D4D4D4" gradientWidth={200} autoFill speed={100} className="flex gap-7" >
