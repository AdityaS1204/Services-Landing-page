...
const Services = () => {
  ...
  return (
    <div className='w-11/12 h-auto p-8 rounded-2xl border border-slate-300 bg-neutral-300/20 shadow-2xl flex flex-col lg:flex-row md:flex-col justify-center gap-5'>
